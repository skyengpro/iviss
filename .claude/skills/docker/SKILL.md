...
---
name: docker
description: Use this skill whenever writing, reviewing, or editing a Dockerfile, docker-compose.yml/yaml, or .dockerignore for MyHouse — including adding a new service, changing a base image, adjusting volumes, or reviewing container security before a commit. Make sure to consult this skill for any Dockerfile or docker-compose change, even a small one, since production-safety rules (non-root user, pinned versions, no secrets in layers) are easy to violate accidentally.
---
# Docker Rules
...
- Pin versions: `FROM node:22.-alpine3.19` (never `:latest`)
