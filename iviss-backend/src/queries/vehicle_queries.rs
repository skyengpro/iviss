...
mod tests {
    ...
    #[test]
    fn test_stolen_status_variations() {
        let status_row_true = VehicleStatusRow {
            insurance_status: None,
            insurance_expiry: None,
            technical_status: None,
            technical_expiry: None,
        ...
        let status_row_false = VehicleStatusRow {
            insurance_status: None,
            insurance_expiry: None,
            technical_status: None,
            technical_expiry: None,
        ...
        assert!(status_row_true.stolen_status);
        assert!(!status_row_false.stolen_status);
    }
}
