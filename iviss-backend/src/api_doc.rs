...
#[openapi(
    ...
    paths(
        ...
        crate::handlers::organization_management::create_organization,
    ...
    components(
        schemas(
            ...
            crate::dto::auth::RefreshChallengeResponse,
            crate::dto::auth::VerifyRefreshRequest,
            crate::dto::auth::VerifyRefreshResponse,
