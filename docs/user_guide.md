...
![Admin Login Screen](../images/1_admin_login_screen.png)

3. Enter your **email address** and **password**
4. Click **Sign In**
5. You'll be redirected to the **Back-Office Dashboard**

![Back-Office Dashboard](../images/2_backoffice_dashboard.png)
...
![Organizations Page](../images/3_organization_page.png)
